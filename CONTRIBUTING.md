...
Open an [issue](https://github.com/akka9655/trustclaw/issues). For bugs, include:
...
If you find a security vulnerability, **don't** open a public issue. File it privately via the repo's security tab.
