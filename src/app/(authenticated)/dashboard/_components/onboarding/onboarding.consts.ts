...
export const MODELS = [
  ...
  {
    value: "claude-sonnet-4-6-20251120" as const,
    label: "Claude Sonnet 4.6",
    description: "Latest & balanced — recommended",
    cost: "$$",
  },
  {
    value: "claude-sonnet-4-5-20250929" as const,
    label: "Claude Sonnet 4.5",
    description: "Reliable & capable",
    cost: "$$",
  },
  {
    value: "claude-3-7-sonnet-20250219" as const,
    label: "Claude 3.7 Sonnet",
    description: "Extended thinking & deep reasoning",
    cost: "$$",
  },
  {
