...
const config = {
  ...
  typescript: {
    ignoreBuildErrors: true, // Set to true to optimize memory usage during build (4GB RAM lab)
  },

  eslint: {
    ignoreDuringBuilds: true, // Set to true to optimize memory usage during build (4GB RAM lab)
  },
};
